...
const secondaryMenuItems = [
  ...
  { name: 'Relatórios', icon: LayoutDashboard, page: 'Reports' },
  { name: 'Estatísticas', icon: LayoutDashboard, page: 'Statistics' },
  { name: 'Usuários', icon: Users, page: 'Users' },
  { name: 'WhatsApp', icon: Bell, page: 'WhatsAppIntegration' },
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center justify-between h-16 px-5 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-semibold text-foreground text-sm tracking-tight">K-Climatização</h1>
            ...
            <nav className="flex-1 py-4 px-3 overflow-y-auto">
              ...
              <div className="mt-6 pt-4 border-t border-border">
                <p className="px-3 mb-2 text-[10px] font-medium text-muted-foreground/50 uppercase tracking-wider">Sistema</p>
                <div className="space-y-1">
            ...
            <div className="p-4 border-t border-border">
              <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-muted transition-colors cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium text-foreground truncate">{user?.full_name || 'Administrador'}</p>
          ...
          <header className="sticky top-0 z-30 h-16 bg-background/80 backdrop-blur-xl border-b border-border">
            <div className="flex items-center justify-between h-full px-4 lg:px-6">
              <div className="flex items-center gap-4">
                <Button variant="ghost" size="icon" className="lg:hidden text-muted-foreground hover:text-foreground hover:bg-muted" onClick={() => setSidebarOpen(true)}>
                ...
                <div className="hidden md:flex items-center">
                  <div className="relative">
                    ...
                    <Input placeholder="Buscar..." className="w-64 pl-9 h-9 bg-muted/50 border-border text-foreground placeholder:text-muted-foreground text-sm focus:border-primary/50 focus:ring-primary/20" />
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-48 bg-popover border-border text-popover-foreground">
                    <div className="p-2 border-b border-border">
                      <p className="text-sm font-medium">{user?.full_name || 'Administrador'}</p>
                      <p className="text-[10px] text-muted-foreground">{user?.email || 'admin@kclimatizacao.com'}</p>
                    </div>
