      ...
      <div className="mx-auto max-w-7xl h-full px-3 flex items-center gap-3">
        ...
        <div className="hidden md:flex items-center gap-2 flex-1">
          <div className="relative w-full max-w-md">
            ...
            <Input className="pl-9 bg-muted border-border" placeholder="Buscar" />
          </div>
          <kbd className="hidden lg:flex items-center gap-1 rounded-md border border-border px-2 py-1 text-xs text-muted-foreground">⌘K</kbd>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button onClick={() => setOpen(v => !v)} className="rounded-full border border-border bg-muted w-8 h-8 flex items-center justify-center">
